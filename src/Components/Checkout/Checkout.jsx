    ...
    <>
      <div className="w-75 mx-auto my-5">
        <form onSubmit={formik.handleSubmit}>
          ...
          <input type="text"id='details'name='details'className='form-control my-3'
          onChange={formik.handleChange}onBlur={formik.handleBlur} />
          <label htmlFor="phone">Phone</label>
          <input type="text"id='phone'name='phone'className='form-control my-3'
          onChange={formik.handleChange}onBlur={formik.handleBlur} />
          <label htmlFor="name">City</label>
          <input type="text"id='city'name='city'className='form-control my-3'
          onChange={formik.handleChange}onBlur={formik.handleBlur} />
