...
export default function Footer() {
  return (
    ...
    <div className=" container">
        ...
        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Minima, porro!</p>
        ...
        <div className="leftPart">
            <ul className='list-unstyled d-flex flex-wrap align-items-center'>
                <li className='text-primary me-2'><h6>Payment Parameters</h6></li>
                <li className='text-primary me-2'><i class="fa-brands fa-paypal"></i></li>
                <li className='text-primary me-2'><i class="fa-brands fa-amazon-pay"></i></li>
