    ...
    <>
{
    products.map((product)=>{
        return(
            <div className="col-md-2 text-center" key={product._id}>
...
<div className='d-flex justify-content-between'>
    ...
    <button onClick={()=>addProduct(product._id)} className='btn w-100 text-white bg-main'>
    
        {loader?<div class="spinner-border spinner-border-sm text-white" role="status">
